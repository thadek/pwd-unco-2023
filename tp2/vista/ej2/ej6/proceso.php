...
if ($_GET){
    ...
    $futbol = $_GET['futbol_form'];
    $basket = $_GET['basket_form'];
    $tennis = $_GET['tennis_form'];
    $voley = $_GET['voley_form'];
    $cantDeportes = $futbol + $basket + $tennis + $voley;
    ...
    $textoDeporte = "practico ".$cantDeportes." deportes";
    if ($cantDeportes == 0){
        $textoDeporte = "no practico ning&uacute;n deporte";
    }

    echo "<h2>Hola, yo soy ".$nombre." ".$apellido.", tengo ".$edad." años, vivo en ".$direccion.", soy "
         .$textoEdad." de edad, ".$textoEstudios.", mi g&eacute;nero es ".$textoGenero." y ".$textoDeporte."</h2>";
} else {
