...
include_once(__DIR__.'/comandos/Comando.php');
...
$comandos = scandir(__DIR__.'/comandos');
...
foreach($comandos as $comando){
    if (pathinfo($comando, PATHINFO_EXTENSION) === 'php') {
        ...
        if(file_exists(__DIR__.'/comandos/'.$nombre.'.php')){
            //Si es la clase padre, no la registro
            if($nombre == 'Comando') continue;
            include __DIR__.'/comandos/'.$nombre.'.php';
